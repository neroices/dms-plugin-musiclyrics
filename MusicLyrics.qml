...
PluginComponent {
    ...
    function chipLabel(val) {
        ...
        // -------------------------------------------------------------------------
        // Bar Pills: show current lyric line with Marquee for long titles
        // -------------------------------------------------------------------------
        ...
        Component {
            ...
            Row {
                ...
                // Lyric / Idle Title Container with Marquee Effect
                Item {
                    id: textContainer
                    // Adjust 300 to your preferred maximum bar allocation width
                    width: Math.min(lyricText.implicitWidth, 300)
                    height: Theme.fontSizeSmall + Theme.spacingXS
                    anchors.verticalCenter: parent.verticalCenter
                    clip: true // Prevents text from spilling out of the bounds
